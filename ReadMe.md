...
The useRouteMatch is used to get access to the matching data without rendering a <Route>.

2. How would you explain form validation to someone who has never programmed before?

Form validation is the process that takes place to make sure that the user is entering the correct information in the form inputs for example required inputs, the correct email format etc.

3. In 1-2 sentences, define end to end testing.

End to end testing is testing the flow of an application or website from start to finish to make sure that the behavior and performance is working as expected.
